...
from .views import save_pos
from .views import inventory, delete_inventory, additional_action
from .views import create_supplier, supplier_list, delete_supplier
...
urlpatterns = [
    ...
    path('collection', views.collection, name="collection-page"),
    path('receipt', views.receipt, name="receipt-modal"),
    path('delete_sale', views.delete_sale, name="delete-sale"),
    path('inventory', views.inventory, name="inventory-page"), #new
    path('save-pos/', save_pos, name='save_pos'),
    path('inventory/', inventory, name='inventory'),
    path('delete-inventory/', delete_inventory, name='delete-inventory'),
    path('additional-action/<int:inventory_id>/', views.additional_action, name='additional-action'), #inventory
